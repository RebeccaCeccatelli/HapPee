...
public class ReviewDAOSuite {
    ...
    public void addRowTest() {
        ...
        reviewDAO.add(32, 41, "test", 5.0, Date.valueOf(LocalDate.now()), Time.valueOf(LocalTime.now()));
        reviewDAO.add(32, 41, "test", 3.0, Date.valueOf(LocalDate.now()), Time.valueOf(LocalTime.now()));
        try {
